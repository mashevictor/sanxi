...
export function buildShowcaseData(): ImportResult {
  ...
  const employees: Employee[] = [
    {
      id: 1, name: '韩哲川', cityId: 1, cityName: '上海市',
    ...
    {
      id: 2, name: '崔宏芝', cityId: 1, cityName: '上海市',
      roles: [EmployeeRole.BACK], status: EmployeeStatus.ACTIVE,
    ...
    {
      id: 3, name: '殷汝飞', cityId: 1, cityName: '上海市',
    ...
    {
      id: 4, name: '王睿', cityId: 1, cityName: '上海市',
      roles: [EmployeeRole.FRONT, EmployeeRole.PROJECT], status: EmployeeStatus.ACTIVE,
    ...
    {
      id: 5, name: '刘帅', cityId: 1, cityName: '上海市',
      roles: [EmployeeRole.FRONT, EmployeeRole.PROJECT], status: EmployeeStatus.ACTIVE,
